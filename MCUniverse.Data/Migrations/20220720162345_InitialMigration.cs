    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseEntityFaculty", x => new { x.CoursesId, x.facultiesId });
                    table.ForeignKey(
                        name: "FK_CourseEntityFaculty_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseEntityFaculty_Faculties_facultiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseEntityFaculty_facultiesId",
                table: "CourseEntityFaculty",
                column: "facultiesId");
